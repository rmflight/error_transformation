...
data allows the detection of proportional error in omics data, and conveniently
shows the effect of various transformations on the error structure as well. We
also find that the log-transform is the most effective method of the common
methods employed for removing proportional error.
